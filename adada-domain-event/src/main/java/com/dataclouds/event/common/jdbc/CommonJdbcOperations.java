package com.dataclouds.event.common.jdbc;
...
public class CommonJdbcOperations {
    ...
    public void insertEventMessage(EventMessage eventMessage) {
        this.jdbcTemplate.update(String.format("INSERT INTO %s (msg_id," +
                ...
                "body)VALUES (?,?,?,?," +
                "?)", EVENT_MESSAGES_TABLE_NAME), new Object[]{eventMessage.getMsgId(),
                eventMessage.getEventAggregateId(),eventMessage.getEventAggregateType(),eventMessage.getEventClassName(),eventMessage.getBody()});
